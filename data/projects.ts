...
export const projects: Project[] = [
  {
    ...
    details: 'A comprehensive brand identity project including logo design, color palette, typography system, and brand guidelines for a modern creative agency.',
  },
  {
    id: 'project-2',
    ...
    details: 'A creative digital marketing campaign featuring social media assets, email templates, and digital advertisements with cohesive visual language.',
  },
  {
    id: 'project-3',
    ...
    details: 'A modern, responsive website design featuring clean layouts, smooth interactions, and optimized user experience across all devices.',
  },
  {
    id: 'project-4',
    ...
    details: 'A comprehensive UI component library with documentation, including buttons, cards, forms, modals, and other reusable design elements.',
  },
  {
    id: 'project-5',
    ...
    details: 'A mobile application design featuring intuitive navigation, beautiful interfaces, and interactive prototypes demonstrating key user flows.',
  },
  {
    id: 'project-6',
    ...
    details: 'A series of visual content pieces and illustrations that tell compelling brand stories through creative design and compelling imagery.',
  },
];
